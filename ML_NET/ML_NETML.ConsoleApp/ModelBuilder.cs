...
namespace ML_NETML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\wag.silva\Desktop\Github\ml_net_study\ML_NET\wikipedia-detox-250-line-data.tsv.txt";
        private static string MODEL_FILEPATH = @"../../../../ML_NETML.Model/MLModel.zip";
